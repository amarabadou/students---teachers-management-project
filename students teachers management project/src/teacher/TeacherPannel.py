...
def open_pdf():
    subprocess.Popen([sys.executable, "pdf2testf.py"])
...
btn_absent.bind("<Enter>", on_enter)
btn_absent.bind("<Leave>", on_leave)


for btn in [btn_pdf, btn_absent]:
    btn.config(
        relief="flat",
